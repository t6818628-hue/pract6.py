...
class Library:
    ...
    def save_data(self):
        with open("books.pkl", "wb") as file:
            pickle.dump(self.__books, file)

        with open("users.pkl", "wb") as file:
            pickle.dump(self.__users, file)
    ...
    def librarian_menu(self):
        while True:
            ...
            print("6. Чтение первых 50 байтов")
            print("7. Выход")
            ...
            if choice == "1":
                ...
                with open("books.pkl", "rb") as file:
                    raw = file.read(50)
                    print(f"Чтение первых 50-ти байтов: {raw}")
            elif choice == "7":
                self.__current_librarian = None
                break
            else:
